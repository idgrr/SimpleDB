...
import simpledb.opt.TesterQueryPlanner;
...
//    Only used for testing purposes. Ensure that database planner is on HueresticQueryPLanner otherwise
//    TesterQueryPlanner qp = new TesterQueryPlanner(mdm); 
