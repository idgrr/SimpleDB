...
public class MetadataMgr {
   ...
   public void createIndex(String idxname, String tblname, String fldname, Transaction tx, String indexType) {
      idxmgr.createIndex(idxname, tblname, fldname, tx, indexType);
   }
